...
\subsection{Mitigation against Package Dropping}
  \begin{table}[H]
    ...
    \begin{tabular}{cddeecccc} \toprule
      \multicolumn{1}{c}{Attackers} & \multicolumn{2}{c}{Server load} & \multicolumn{2}{c}{Legitimate users} & \multicolumn{2}{c}{Mobile devices} \\
      %\unitfrac{ml}{min} & \multicolumn{2}{c}{mS} & & & \multicolumn{2}{c}{mmHg} & \textcelsius  \\ \midrule
      \multicolumn{1}{c}{Population size} & \multicolumn{1}{c}{CPU} & \multicolumn{1}{c}{Request rate} & \multicolumn{1}{c}{Response time} & \multicolumn{1}{c}{Solving time} & \multicolumn{1}{c}{Response time} & \multicolumn{1}{c}{Solving time}  \\ \toprule
